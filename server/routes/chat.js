...
function getFallbackResponse(message) {
  ...
  // --- Registration ---
  if (lower.includes('register') || lower.includes('enrollment') || lower.includes('enrol')) {
  ...
  // --- Voter ID / EPIC ---
  if (lower.includes('voter id') || lower.includes('epic') || lower.includes('voter card') || lower.includes('election card')) {
  ...
  // --- Eligibility ---
  if (lower.includes('eligible') || lower.includes('eligibility') || lower.includes('who can vote') || lower.includes('qualify')) {
  ...
  // --- EVM ---
  if (lower.includes('evm') || lower.includes('electronic voting') || lower.includes('voting machine')) {
  ...
  // --- VVPAT ---
  if (lower.includes('vvpat') || lower.includes('paper trail') || lower.includes('paper audit')) {
  ...
  // --- NOTA ---
  if (lower.includes('nota') || lower.includes('none of the above') || lower.includes('reject all')) {
  ...
  // --- Counting ---
  if (lower.includes('count') || lower.includes('tally') || lower.includes('how are votes')) {
  ...
  // --- Election Commission ---
  if (lower.includes('election commission') || lower.includes('eci') || lower.includes('who conducts')) {
  ...
  if (lower.includes('model code') || lower.includes('code of conduct') || lower.includes('mcc')) {
  ...
  // --- Phases / Schedule ---
  if (lower.includes('phase') || lower.includes('schedule') || lower.includes('how many days') || lower.includes('stages')) {
  ...
  // --- Postal ballot ---
  if (lower.includes('postal') || lower.includes('absentee') || lower.includes('mail ballot') || lower.includes('vote from home')) {
  ...
  // --- Deadline ---
  if (lower.includes('deadline') || lower.includes('last date') || lower.includes('miss')) {
  ...
  // --- Constituency ---
  if (lower.includes('constituency') || lower.includes('how many seats') || lower.includes('lok sabha') || lower.includes('rajya sabha')) {
  ...
  // --- Results / Who wins ---
  if (lower.includes('result') || lower.includes('who wins') || lower.includes('majority') || lower.includes('form government')) {
  ...
  // --- Campaigning ---
  if (lower.includes('campaign') || lower.includes('rally') || lower.includes('propaganda') || lower.includes('advertising')) {
  ...
  if (lower.includes('booth') || lower.includes('polling station') || lower.includes('where do i vote') || lower.includes('where to vote')) {
  ...
  // --- Thank you / bye ---
  if (lower.includes('thank') || lower.includes('bye') || lower.includes('goodbye') || lower.includes('see you')) {
  ...
  // --- What is ElectionIQ ---
  if (lower.includes('what are you') || lower.includes('who are you') || lower.includes('what can you do') || lower.includes('about you')) {
...
router.post('/', async (req, res) => {
  try {
    ...
    if (!apiKey || apiKey === 'your_gemini_api_key_here') {
      return res.json({ reply: getFallbackResponse(sanitizedMessage), source: 'fallback' });
    }
    ...
    if (error.message?.includes('API_KEY')) {
      return res.json({ reply: getFallbackResponse(req.body?.message || ''), source: 'fallback' });
    }
